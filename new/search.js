//Modesl, Views, Collections & Controllers :)
(function ($) {
...
var Numbers_Collection = Backbone.Collection.extend({
	...
	//helper function to show if no resutls are returned	
...
var AppView = Backbone.View.extend({
	...
	Get_List:function(model){
		...
		if (matched==null) 
			{ list.no_result("#result-list");list.no_result("#result-list-2");	return;		}
		...
		if (matched==null) 
			   { list.no_result("#result-list-2");	return; }
		//console.log(matched);		
		matched=list.select_popular(matched);	
